...
#ifndef __LATTE_C_PLUS_IMMUTABLE_DB_OPTIONS_H
#define __LATTE_C_PLUS_IMMUTABLE_DB_OPTIONS_H
...
#include "io/file_checksum.h"
#include "sst/sst_file_manager.h"
...
namespace latte
{
    namespace rocksdb
    {
        ...
        struct ImmutableDBOptions {
            ...
            std::shared_ptr<latte::log::Logger> info_log;
            latte::log::InfoLogLevel info_log_level;
