...
#ifndef __LATTE_C_PLUS_DB_TABLE_CACHE_H
#define __LATTE_C_PLUS_DB_TABLE_CACHE_H

#include "../options/immutable_options.h"
#include "../cache/cache.h"
#include "../io/io_tracer.h"
#include "../trace/block_cache_tracer.h"
...
#include "./table_reader_caller.h"
#include "statistics/histograms.h"
#include "./table_reader.h"
#include "./table_properties.h"
#include "../table/basic_typed_cache_interface.h"
...
namespace latte
{
    ...
    namespace rocksdb
    {
        ...
        class TableCache {
            ...
            static CacheHandle* Lookup(Cache* cache, uint64_t file_number);
