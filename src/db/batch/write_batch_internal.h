...
#ifndef __LATTE_C_PLUS_WRITE_BATCH_INTERNAL_H
#define __LATTE_C_PLUS_WRITE_BATCH_INTERNAL_H
...
#include "../types.h"
#include "../write_thread/write_thread.h"
#include "../write_thread/write.h"
#include "../write_thread/write_state.h"
#include "../column_family/column_family_handle.h"
#include "../column_family/column_family_mem_tables.h"
#include "../scheduler/flush_scheduler.h"
#include "../scheduler/trim_history_scheduler.h"
    ...
    namespace rocksdb
    {
        ...
        class WriteBatchInternal {
            public:
                ...
                // 使用 column_family_id 而不是 ColumnFamilyHandle* 的 WriteBatch 方法
                ...
                static Status InsertInto(Writer* writer, SequenceNumber sequence,
